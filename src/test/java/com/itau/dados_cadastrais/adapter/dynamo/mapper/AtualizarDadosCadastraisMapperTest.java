...
class AtualizarDadosCadastraisMapperTest {
  @Spy
  private AtualizarDadosCadastraisMapper mapper = Mappers.getMapper(AtualizarDadosCadastraisMapper.class);

  @Test
  @DisplayName("teste mapper atualiza dados cadastrais")
