...
@Component
public class CadastrarDadosCadastraisMapperImpl implements CadastrarDadosCadastraisMapper {
    ...
    public ClienteEntity toEntity(Cliente cliente) {
        ...
        clienteEntity.endereco( CadastrarDadosCadastraisMapper.toTextoObjetoEndereco( cliente.getEndereco() ) );
    ...
    public Cliente toDomain(ClienteEntity clienteEntity) {
        ...
        cliente.endereco( CadastrarDadosCadastraisMapper.toTextoObjetoEndereco( clienteEntity.getEndereco() ) );
