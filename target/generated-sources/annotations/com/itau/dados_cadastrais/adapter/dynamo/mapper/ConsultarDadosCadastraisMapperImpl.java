...
@Component
public class ConsultarDadosCadastraisMapperImpl implements ConsultarDadosCadastraisMapper {
    ...
    public ClienteEntity toEntity(Cliente cliente) {
        ...
        clienteEntity.endereco( ConsultarDadosCadastraisMapper.toTextoObjetoEndereco( cliente.getEndereco() ) );
    ...
    public Cliente toDomain(ClienteEntity clienteEntity) {
        ...
        cliente.endereco( ConsultarDadosCadastraisMapper.toTextoObjetoEndereco( clienteEntity.getEndereco() ) );
