...
@Component
public class DeletarDadosCadastraisMapperImpl implements DeletarDadosCadastraisMapper {
    ...
    public ClienteEntity toEntity(Cliente cliente) {
        ...
        clienteEntity.endereco( DeletarDadosCadastraisMapper.toTextoObjetoEndereco( cliente.getEndereco() ) );
    ...
    public Cliente toDomain(ClienteEntity clienteEntity) {
        ...
        cliente.endereco( DeletarDadosCadastraisMapper.toTextoObjetoEndereco( clienteEntity.getEndereco() ) );
